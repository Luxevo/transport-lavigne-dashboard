      ...
      <div className="flex items-center gap-2">
        ...
        {pagesAroundCurrent.map((page) => (
          <button
            ...
            className={`px-4 py-2 rounded ${ currentPage === page ? "bg-brand-500 text-white" : "text-gray-700" } flex w-10 items-center justify-center h-10 rounded-lg text-sm font-medium hover:bg-blue-500/[0.08] hover:text-brand-500`}
          >
            {page}
          </button>
        ))}
